---
title: 'The Complete Guide to Achieving 90+ PageSpeed Scores: A Real-World Case Study'
date: '2026-02-01'
tags:
  - performance
  - nextjs
  ...
  - optimization
draft: false
summary: 'Learn how we optimized our Next.js website from 65 to 90+ on PageSpeed Insights. Step-by-step guide covering accessibility, performance, SEO, and security optimizations.'
images:
  - '/static/images/nextjs-seo.png'
authors:
  - default
---
...
<StickyMobileCTA title="Want guaranteed 90+ scores? We can optimize your site." buttonText="Get Expert Help" href="/services" />
...
## Accessibility Fixes That Matter
...
<p className="text-gray-800 bg-white">...</p>
```
...
## JavaScript Performance & Modern Browsers
...
export default function RootLayout({ children }) {
  const jsonLd = {
    ...
    sameAs: ['https://twitter.com/stryxon', 'https://linkedin.com/company/stryxon'],
  }
...
export const metadata = {
  ...
  description: 'Professional web development and cloud infrastructure services...',
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://www.stryxon.com',
...
This guide is based on our real-world experience optimizing blog.stryxon.com from scratch. We documented every step, challenge, and solution so you don't have to learn the hard way.
